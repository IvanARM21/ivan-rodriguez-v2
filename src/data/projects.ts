...
export const projects : Project[] = [
    {
        title: "Coffee Code",
        description: "Coffee code is a webpage designed to showcase our web development skills. The project features a beautiful design with animations created using React Motion. It's fully responsive and highly performant, thanks to astro and optimized images. Additionally the project is SEO-friendly.",
    ...
    },
    {
        ...
        description: `Trendy Threads is an e-commerce project designed to showcase our web development skills. The project is still in development. 
